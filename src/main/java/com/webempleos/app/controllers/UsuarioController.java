...
import com.webempleos.app.service.implementations.MailService;
...
//        Verificamos que el archivo no este vacio
        ...
        //Mail
        mailService.sendMail("company@noreply.com", usuario.getEmail(), "MiWorks - Encuentra tu mejor trabajo!", "Bienvenido a MiWorks "+ usuario.getNombre() +"!");
        //
